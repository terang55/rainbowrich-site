...
export const metadata: Metadata = {
  title: '부동산 계산기 모음 | 무료 부동산 투자 계산 도구',
  description: '부동산 투자에 필요한 모든 계산기를 한 곳에서! 갭투자 수익률, 전세가율, 대출 이자, ROI 시뮬레이터, 아파트 적정가 계산기를 무료로 이용하세요. 부동산 투자 결정을 더 쉽고 정확하게!',
  keywords: [
    '부동산 계산기', '무료 부동산 계산기', '부동산 투자 계산기',
    '갭투자 계산기', '전세가율 계산기', '부동산 대출 계산기', '부동산 ROI 계산기',
    '아파트 적정가 계산기', '부동산 투자 도구', '부동산 수익률 계산',
    '부동산 투자 분석', '부동산 현금흐름 계산', '부동산 투자 시뮬레이션'
  ],
  openGraph: {
    title: '부동산 계산기 모음 | 무료 부동산 투자 계산 도구',
    description: '부동산 투자에 필요한 모든 계산기를 한 곳에서! 갭투자, 전세가율, 대출 이자 등 5가지 무료 부동산 계산기로 투자 결정을 더 쉽고 정확하게!',
          ...
          __html: JSON.stringify([
            {
              ...
              "@type": "WebApplication",
              "name": "부동산 계산기 모음",
              "description": "부동산 투자에 필요한 모든 계산을 한 곳에서 할 수 있는 무료 부동산 계산기 모음",
              "url": "https://rainbowrich.site/tools",
